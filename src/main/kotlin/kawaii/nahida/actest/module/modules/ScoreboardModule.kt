        ...
        Bukkit.getScoreboardManager()?.let {
            ...
            try {
                arrayOf(
                    ...
                    "${ChatColor.WHITE}PPS(C): ${ChatColor.GREEN}${ACTest.statisticsManager.getPlayerData(player).ppsc.get(1000)}",
                    "${ChatColor.WHITE}PPS(S): ${ChatColor.GREEN}${ACTest.statisticsManager.getPlayerData(player).ppss.get(1000)}",
                    "${ChatColor.WHITE}",
